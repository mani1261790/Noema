...
Studioは保存ごとにimmutable revisionを残しながら、画面では同じ編集セッションの自動保存を1つの「版」にまとめます。記事を開き直した時、30分以上編集が空いた時、手動保存、競合解消、過去版の復元、レビュー・承認・公開の後に次の版を開始します。履歴には最新50版を新しい順に表示し、各版の保存回数、更新者、時刻、現在編集中・承認済み・公開中の状態を確認できます。
